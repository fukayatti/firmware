...
import {
  Gamepad2, Terminal, Layers, Settings2, Subtitles, AlertCircle, X, Key, TerminalSquare, Keyboard
} from 'lucide-react'
...
import { BadUsbTab } from './components/BadUsbTab'
...
const TABS: Tab[] = [
  ...
  { id: 'badusb',   label: 'BadUSB',   icon: TerminalSquare },
...
export default function App() {
  ...
  const renderTab = () => {
    switch (tab) {
      ...
      case 'badusb':   return <BadUsbTab   logs={logs} onCommand={handleSend} connected={bleState.connected} />
      case 'keyboard': return <KeyboardTab onCommand={handleSend} connected={bleState.connected} />
